...
#define CUSTOM_MACHINE_NAME "iDJMic CR-10 v2.0.6 bug-fix"
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FIL_RUNOUT_STATE LOW // Set to HIGH (true) to invert the logic of the sensor.
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIXELS 81       // Number of LEDs in the strip, larger of 2 strips if 2 neopixel strips are used
